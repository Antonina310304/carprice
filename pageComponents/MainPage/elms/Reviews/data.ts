...
export const reviewsList: IReviewsList[] = [
  ...
  },
  {
    ...
    rating: 4.5,
    review:
      'Так случилось, что срочно понадобились деньги! Было авто! Решил продать!'
      + 'В голове была мысль о carprice. Почитал отзывы, созвонился. И мою проблему'
      + 'решили за 3 часа под ключ! Я доволен. И рекомендации только работать с ними!',
  },
  {
    name: 'Василий',
    auto: 'Citroen C5 2004 года',
